...
<div>
  <ul class="w3-navbar ">
    <li>
      <a href="index.php" class="w3-margin-left"><b>Shivam </b> Patel</a>
    </li>
    <li class="w3-right w3-hide-small">
      <a href="#projects" class="w3-left">Projects</a>
      <a href="#resume" class="w3-left w3-margin-right">Resume</a>
      <a href="#about" class="w3-left">About</a>
      <a href="#contact" class="w3-left">Contact</a>
      <a href="#work" class="w3-left">Work</a>
    </li>
  </ul>
</div>

<div class="w3-container " style="background-image: url('img/banner.jpg') !important;">
	<h1 class="introtitle w3-opacity">Hello</h1>
	<h2 class="w3-opacity name w3-center" >My Name is <b style="font-size: 88px;">Shivam Patel</b>
	<br></h2>
</div>
